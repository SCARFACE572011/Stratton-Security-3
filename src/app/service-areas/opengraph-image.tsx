    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ fontSize: "12px", color: "#3f6bb0", letterSpacing: "0.2em", textTransform: "uppercase" }}>LOS ANGELES &amp; SOUTHERN CALIFORNIA</div>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          {["Los Angeles", "Beverly Hills", "West Hollywood", "Santa Monica", "Century City", "Culver City", "Pasadena"].map((p) => (
            <div key={p} style={{ padding: "6px 14px", border: "1px solid rgba(63,107,176,0.4)", fontSize: "11px", color: "#c0c8d4", letterSpacing: "0.06em", textTransform: "uppercase" }}>
              {p}
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontSize: "11px", color: "#6b7280", letterSpacing: "0.08em", textTransform: "uppercase" }}>Headquarters: Los Angeles · Serving All of LA County</span>
          <span style={{ fontSize: "12px", color: "#c0c8d4" }}>strattonsecuritygroup.com/service-areas</span>
        </div>
