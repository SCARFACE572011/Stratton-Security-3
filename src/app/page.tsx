...
export default function HomePage() {
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[#cc1111] focus:text-[#06101e] focus:text-sm focus:font-600"
      >
